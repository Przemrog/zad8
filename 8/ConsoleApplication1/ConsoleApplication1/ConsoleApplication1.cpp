...
int zad7(int f, int g) {
	...
	if (*wsk7f > *wsk7g) {
		cout << *wsk7g << endl << wsk7g;
	}
	else {
		cout << *wsk7f << endl << wsk7f;
	}
	return 0;
}

void zad8(int h, int j) {
...
int main()
{
	...
	*/
	...
	int f;
	cout << "Podaj pierwsza liczbe: ", cin >> f;
	int g;
	cout << "Podaj druga liczbe: ", cin >> g;
	...
	*/
	...
	int h;
	cout << "Podaj pierwsza liczbe: ", cin >> h;
	int j;
	cout << "Podaj pierwsza liczbe: ", cin >> j;
